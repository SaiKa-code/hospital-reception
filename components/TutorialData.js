...
export const TutorialPatients = [
    ...
    // =========================================================================
    {
        ...
        prescription: 'ゲミテア / ゲオーダ',
        prescriptionDays: '28日 / 28日',
        // 🆕 チュートリアル用: 1番目の薬に名前エラーを設定（CheckSceneで動的に生成）
        prescriptionErrors: [
            { type: 'name', index: 0, message: '薬名が正しくありません' }
        ],
        注射: 0,
        処置: 0,
        麻酔: 0,
    ...
    // =========================================================================
    {
        ...
        questionnaireData: {
            ...
            duration: 'ED治療',
            allergies: 'なし',
            currentMedications: 'ミアレスト（ED治療薬）'
        }
    },
...
export const TutorialAnswers = {
    patient1: {
        ...
        prescriptionError: true     // 🆕 チュートリアル用エラーあり
    },
    patient2: {
        id: null,
        name: '佐藤 太郎',
