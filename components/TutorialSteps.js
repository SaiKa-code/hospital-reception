...
export const TutorialSteps = [
    ...
    },
    {
        ...
        scene: 'ReceptionScene',
        action: 'click',
        message: 'この患者さんはマイナンバーだから入力不要よ！\n「暗証番号コピー＆照会」を押して！',
        speaker: 'トリアージさん',
        targetButton: 'mynumber_confirm_button',
        completeOn: 'MYNUMBER_CONFIRMED',
        arrow: { direction: 'down', offset: { x: 0, y: 0 } }
    },
    {
        ...
        targetButton: 'reception_complete_button',
        completeOn: 'RECEPTION_COMPLETED',
        allowFreeOperation: true  // 🆕 受付票が表示されるまでフォーム操作を許可
    },
    {
        id: 'patient2_done',
        phase: 4,
    ...
    },
    {
        ...
        speaker: 'トリアージさん',
        targetButton: 'karte_panel',
        completeOn: 'NEXT_CLICK',
        arrow: { direction: 'right' }  // カルテを指す
    },
    {
        ...
        scene: 'CheckScene',
        action: 'info',
        message: '処方箋には「一般名」が書かれているわ→\n薬辞典で対応関係を確認してね！',
        speaker: 'トリアージさん',
        targetButton: 'prescription_document',
        completeOn: 'NEXT_CLICK',
        arrow: { direction: 'left' }  // 処方箋を指す
    },
    {
        id: 'check_dict_desc',
        phase: 6,
