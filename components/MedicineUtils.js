 ...
 *   
 *   const fakeName = MedicineUtils.convertToFakeName('ズキラック', medicineData, chineseMedicineData);
 *   const info = MedicineUtils.getMedicineInfo('ズキラック', medicineData, chineseMedicineData);
 */
