...
export class TutorialScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.voiceMapping = {
            ...
            2: 'novel_vc_003',    // 「私はトリアージ」
            3: 'novel_vc_004',    // 「ここは今、人手が…
            4: 'novel_vc_005',    // 「特にうちみたいな… (選択肢あり)
            5: 'novel_vc_006',    // 「あと、一番助かる…
            6: 'novel_vc_007',    // 「今、うちは絶賛『…
            7: 'novel_vc_008',    // 「例えるなら、『最…
            9: 'novel_vc_010',    // 「そうなの！ 紙カ…
            10: 'novel_vc_011',   // 「でも、Ｔ橋家技大… (選択肢あり)
            11: 'novel_vc_012',   // 「冗談よ！ でも、…
            12: 'novel_vc_013',   // 「さあ、いい働きを期待しているわ」
        };
        
        // 選択肢への反応ボイス
        this.responseVoiceMapping = {
            '4_A': 'novel_vc_004_1',   // 「あはは！ 頼もし…
            '4_B': 'novel_vc_004_2',   // 「そんなに固くなら…
            '10_A': 'novel_vc_011_1',  // 「やっぱり！ 専門…
            '10_B': 'novel_vc_011_2',  // 「あら、照れ屋ね？…
        };
